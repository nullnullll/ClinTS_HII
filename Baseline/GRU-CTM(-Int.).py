...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        ...
        for train_batch, label in train_loader:
            ...
            if args.task == 'wbm':
                loss = criterion(pred_y, label.float())
            else:
        ...
        message = 'Iter: {},   ce_loss: {:.4f}, val_loss: {:.4f}, val_acc: {:.4f}, val_auroc_macro: {:.4f}, val_auprc: {:.4f}, test_acc: {:.4f}, test_auroc_macro: {:.4f}, test_auprc: {:.4f}' \
                .format(itr, train_loss / train_n, val_loss, val_acc, val_auroc, val_auprc, test_acc,test_auroc, test_auprc)
        print(message)
